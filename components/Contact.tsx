...
export default function Contact() {
  return (
    <section id="contact" className="relative overflow-hidden border-t border-edge py-28 md:py-40">
      {/* closing glow */}
      <div
        className="pointer-events-none absolute left-1/2 top-0 h-[28rem] w-[50rem] -translate-x-1/2 rounded-full blur-3xl"
      ...
      <footer className="relative mx-auto mt-28 max-w-shell border-t border-edge px-6 pt-8">
        <div className="flex flex-col items-center justify-between gap-3 text-center sm:flex-row sm:text-left">
          <p className="font-mono text-2xs text-faint">
            © {new Date().getFullYear()} Arpit Garg · Adelaide, Australia
          </p>
          <p className="font-mono text-2xs text-faint">
            Next.js · Tailwind · Framer Motion — designed to be read, built to move.
          </p>
        </div>
      </footer>
    </section>
